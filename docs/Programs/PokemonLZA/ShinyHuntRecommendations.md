...
| Fennekin<br>Lopunny (Alpha)<br>Noibat<br>Noivern<br>Swablu<br>Alteria<br>Salamence (Alpha)<br>Bagon<br>Kakuna (Alpha)<br>Weedle<br>Trubbish<br>Mawil/Gastly  | 1. Enter the Zone from the fly point.<br>2. Head down the left alleyway and out the exit near the scaffolding.<br>3. Climb the scaffolding.<br><br>**Run Forward Direction:** 0 | <img src="images/ShinyHuntLocations/BenchSit-Fennekin.png" width="300"> |
| Avalugg (Alpha)<br>Abomasnow (Alpha)<br>Snover<br>Delibird<br>Vanillite| West entrance of Wild Zone 12| <img src="images/ShinyHuntLocations/BenchSit-Avalugg.png" width="300"> |
