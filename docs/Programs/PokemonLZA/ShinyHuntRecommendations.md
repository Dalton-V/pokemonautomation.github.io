...
| Ralts<br>Weedle<br>Shuppet<br>Dedenne<br>Eevee<br>Abra<br>Hawlucha<br>Absol | There are 2 Ralts spawners just north of Magenta Sector 7.<br>On the roof of these buildings there are two sets of benches. One on a lower roof and one on a higher roof.<br>These benches cover almost the exact same spawns. The higher section can see Absol but Hawlucha might be slightly out of range. The lower set can see Hawlucha but can't see Absol so it is unconfirmed if that spawn is in range.<br><br>**Run Forward Direction:** 0 | [<img src="images/ShinyHuntLocations/BenchSit-Ralts-small.png" width="300">](images/ShinyHuntLocations/BenchSit-Ralts.png) |
...
| Fennekin<br>Lopunny (Alpha)<br>Noibat<br>Noivern<br>Swablu<br>Alteria<br>Salamence (Alpha)<br>Bagon<br>Kakuna (Alpha)<br>Weedle<br>Trubbish<br>Mawil/Gastly  | 1. Enter the Zone from the fly point.<br>2. Head down the left alleyway and out the exit near the scaffolding.<br>3. Climb the scaffolding.<br><br>**Run Forward Direction:** 0 | [<img src="images/ShinyHuntLocations/BenchSit-Fennekin-small.png" width="300">](images/ShinyHuntLocations/BenchSit-Fennekin.png) |
| Avalugg (Alpha)<br>Abomasnow (Alpha)<br>Snover<br>Delibird<br>Vanillite| West entrance of Wild Zone 12| [<img src="images/ShinyHuntLocations/BenchSit-Avalugg-small.png" width="300">](images/ShinyHuntLocations/BenchSit-Avalugg.png) |
| Spritzee (Alpha)<br>Espurr | Rooftop of Rouge Sector 7, next to Wild Zone 13.<br>Espurr spawns in the alley below. | [<img src="images/ShinyHuntLocations/BenchSit-Spritzee-small.png" width="300">](images/ShinyHuntLocations/BenchSit-Spritzee.png)<br>[<img src="images/ShinyHuntLocations/BenchSit-EspurrAlley-small.png" width="300">](images/ShinyHuntLocations/BenchSit-EspurrAlley.png) |
| Manectric (Alpha)<br>Meowstic (Alpha)<br>Carbink<br>Sableye<br>Espurr<br>Mawil (downstairs)<br>Flechinder| Bench beside static Alpha Manectric on rooftop, in Wild Zone 9<br>**Run Forward Direction:** 2000 ms| [<img src="images/ShinyHuntLocations/BenchSit-WZ9-small.png" width="300">](images/ShinyHuntLocations/BenchSit-WZ9.png) |
| Banette (Alpha)<br>Beedrill (Alpha)<br>Gourgeist (Alpha)<br>Scolipede| Bench inside Wild Zone 15 | [<img src="images/ShinyHuntLocations/BenchSit-Banette.jpg" width="300">](images/ShinyHuntLocations/BenchSit-Banette.jpg) |
| Absol (Alpha)<br> Pansage | Bench on a building, West of Wild Zone 19.<br><br>**Run Forward Direction:** 0 | [<img src="images/ShinyHuntLocations/BenchSit-Absol-small.png" width="300">](images/ShinyHuntLocations/BenchSit-Absol.png)<br>[<img src="images/ShinyHuntLocations/BenchSit-AbsolMap-small.png" width="300">](images/ShinyHuntLocations/BenchSit-AbsolMap.png)|
| Slowpoke<br> Carvanha<br> Sharpedo (Alpha)<br> Tynamo | Bench looking over the water, center of Wild Zone 10.<br><br>**Run Forward Direction:** 0 | [<img src="images/ShinyHuntLocations/BenchSit-Sharpedo-small.png" width="300">](images/ShinyHuntLocations/BenchSit-Sharpedo.png)|
| Pyroar (Alpha)<br> Skarmory| Bench East side of Wild Zone 17.<br>Due to the aggressive Pyroar you will need to be quick to start the program.<br><br>**Run Forward Direction:** 0 | [<img src="images/ShinyHuntLocations/BenchSit-Pyroar-small.png" width="300">](images/ShinyHuntLocations/BenchSit-Pyroar.png) |
| Trubbish (Alpha)| Bench center of Vert Sector 5.<br><br>**Run Forward Direction:** 0 | [<img src="images/ShinyHuntLocations/BenchSit-Trubbish.jpg" width="300">](images/ShinyHuntLocations/BenchSit-Trubbish.jpg)<br>[<img src="images/ShinyHuntLocations/BenchSit-Trubbish-Map.jpg" width="300">](images/ShinyHuntLocations/BenchSit-Trubbish-Map.jpg) |
| Swirlix | Bench South West of Wild Zone 16. Need to climb a building to enter the courtyard.<br>This bench has 5 Swirlix spawns.<br><br>**Run Forward Direction:** 0 | [<img src="images/ShinyHuntLocations/BenchSit-Swirlix-small.jpg" width="300">](images/ShinyHuntLocations/BenchSit-Swirlix.png)<br>[<img src="images/ShinyHuntLocations/BenchSit-SwirlixMap-small.jpg" width="300">](images/ShinyHuntLocations/BenchSit-SwirlixMap.png) |
...
| Magikarp (Alpha)<br>Staryu (Alpha)<br>Trubbish (Alpha) | **Wild Zone 2**<br> **Walk Time in Zone:** 0 ms <br><br> Alpha Trubbish is located South of the Gate in Vert Sector 5 | [<img src="images/ShinyHuntLocations/WildZone2-ShalphaMagikarp-small.png" width="300">](images/ShinyHuntLocations/WildZone2-ShalphaMagikarp.png) |
...
| Weedle<br>Kakuna<br>Spinarak<br>Gastly| **Wild Zone 4**<br> **Movement:** Approach Gate But Don't Enter.<br><br>Weedle and Kakuna spawn in the tree to the North.<br>Spinarak and Gastly will spawn just inside the gate. | [<img src="images/ShinyHuntLocations/WildZone4-WeedleKakuna-small.png" width="300">](images/ShinyHuntLocations/WildZone4-WeedleKakuna.png) |
...
| Vanillite<br>Hippopotas<br>Fletchinder (Alpha) | **Wild Zone 7**<br> **Walk Time in Zone:** 500 ms | [<img src="images/ShinyHuntLocations/WildZone7-VanilliteHippopotas-small.png" width="300">](images/ShinyHuntLocations/WildZone7-VanilliteHippopotas.png) |
...
| Salamence (Alpha)<br>Bagon | **Wild Zone 18**<br>Walk Time only needed for the Bagon. | [<img src="images/ShinyHuntLocations/WildZone18-Salamence-small.png" width="300">](images/ShinyHuntLocations/WildZone18-Salamence.png) |
